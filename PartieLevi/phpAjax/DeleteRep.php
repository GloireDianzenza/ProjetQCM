<?php
include "../cnx.php";
$sql1=$cnx->prepare("DELETE FROM questionreponse WHERE idQuestion=11 and idReponse=".$_POST['idRep']."");
$sql1->execute();

$sql2=$cnx->prepare("DELETE FROM reponse WHERE idReponse=".$_POST['idRep']);
$sql2->execute();
